...
# -*- coding: utf-8 -*-
#
# Wikidata documentation build configuration file, created by
# sphinx-quickstart on Sun Feb 19 05:48:40 2017.
#
...
from wikidata import __version__  # noqa: E402
...
version = __version__[:__version__.rindex('.')]
...
latex_documents = [
    (master_doc, 'Wikidata.tex', 'Wikidata Documentation',
     'Hong Minhee', 'manual'),
]
...
man_pages = [
    (master_doc, 'wikidata', 'Wikidata Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Wikidata', 'Wikidata Documentation',
     author, 'Wikidata', 'One line description of project.',
     'Miscellaneous'),
]
